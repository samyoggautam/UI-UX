...
import 'package:assignmentfinal/config/error_handling.dart';
...
import 'package:assignmentfinal/features/auth/domain/entity/user.dart';
    ...
    try {
      ...
      httpErrorHandle(
        ...
        onSuccess: () {
          ...
          showSnackBar(context, 'Booking sucessfull',
              backgroundColor: const Color.fromARGB(255, 67, 227, 113));
        },
      );
    } catch (e) {
